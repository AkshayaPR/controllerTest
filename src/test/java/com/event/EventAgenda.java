...
event.add(new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age).build());
event.add(new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age).build());
event.add(new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age).build());
return event;
} 
...
age.add(a1);
age.add(a3);
Event event1=new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age).build();
return event1;
 }
...
Event e1=new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age1).build();
Event e2=new EventBuilder().id(1L).edition(2).fulldate("29Aug2017").date("29/8/2017").month("august").location("block2").active(true).agenda(age1).build();
